...
@Configuration
@EnableJpaRepositories(basePackages = "com.narasimha.angularspringboot.repositories",
...
public class DataSourceConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.narasimha.angularspringboot.model" });
